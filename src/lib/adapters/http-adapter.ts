import {HttpServer, NestApplicationOptions, RequestHandler} from "@/lib/contracts";
import {CorsOptions, CorsOptionsDelegate} from "../contracts/cors-options.interface";
