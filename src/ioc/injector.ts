...
export class Injector {
  ...
  public async resolveComponentInstance<T>(
    ...
    const instanceWrapper = await this.lookupComponent(
      providers, moduleRef, { ...dependencyContext, name }, wrapper, contextId, inquirer, keyOrIndex,
    );
  ...
  public async resolveComponentHost<T>(
    ...
    if (!instanceHost.isResolved && !instanceWrapper.forwardRef) {
      ...
      !instanceHost.isResolved && instanceWrapper.forwardRef && (contextId !== STATIC_CONTEXT || !!inquirerId)
    ) {
  ...
  public async lookupComponent<T = any>(
    providers: Map<string | symbol, InstanceWrapper>, moduleRef: Module, dependencyContext: IInjectorDependencyContext,
    wrapper: InstanceWrapper<T>, contextId = STATIC_CONTEXT, inquirer?: InstanceWrapper, keyOrIndex?: string | number
